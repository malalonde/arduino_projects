...
button_a = digitalio.DigitalInOut(board.IO6)
button_a.direction = digitalio.Direction.INPUT
button_a.pull = digitalio.Pull.UP

slot_sensor_a = digitalio.DigitalInOut(board.IO2)
slot_sensor_a.direction = digitalio.Direction.INPUT
slot_sensor_a.pull = digitalio.Pull.DOWN

slot_sensor_b = digitalio.DigitalInOut(board.IO4)
...
while True:
    ...
    detected = poll_slot_sensor_until(1)
    #if detected:
